...
Area_HIT_module = 1.26

Modules_per_surface = Surfaces_angles_areas.transpose()
Modules_per_surface = Modules_per_surface.Area//Area_HIT_module
Modules_per_surface = Modules_per_surface.rename(index={'SurfaceASE': 'ASE', 'SurfaceASW': 'ASW', 'SurfaceBW': 'BW', 'SurfaceBE': 'BE', 'SurfaceBS': 'BS', 'RoofCS': 'CS', 'RoofCN': 'CN', 'RoofDE': 'DE', 'RoofDW': 'DW', 'RoofA': 'A', 'RoofB': 'B'})
#4.3 plots of each building for 3 days: 23/4, 23/7 and 23/10
Power_AC_total = Power_AC*Modules_per_surface
